CREATE OR REPLACE VIEW dune_user_generated.xrob_looksrare_wash AS
(
-- ####################
-- 1. SOURCE TABLES
-- ####################
with trades_erc721 as (
    select a.*
    from dune_user_generated.sohwak_os_nft_trades_looksrare a
    inner join dune_user_generated.kqian_erc_standard_all b
        on b.nft_contract_address = a.nft_contract_address
          and b.erc_standard = 'erc721'
